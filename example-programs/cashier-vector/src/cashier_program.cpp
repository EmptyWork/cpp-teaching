...
void Program::setItemInfo(std::vector<int> itemPrice, std::vector<int> itemDiscount, std::vector<std::string> itemName){
...
void Program::showItemInfo(std::vector<int> itemPrice, std::vector<int> itemDiscount, std::vector<std::string> itemName) {
  idProgram(false);
